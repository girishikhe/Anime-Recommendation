from anime.src.data_loader import AnimeDataLoader
from anime.src.vector_store import VectorStoreBuilder
...
def main():
    try:
        ...
        loader = AnimeDataLoader("anime/data/anime_with_synopsis.csv" , "data/anime_updated.csv")
